                                ...
                                <table class="table table-editable table-nowrap align-middle table-edits">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-id="{{ $item->id }}">
                                            ...
                                            <td>
                                                <i class="bx bx-edit bx-sm" data-bs-toggle="modal" data-bs-target="#editModal" data-id="{{ $item->id }}" data-menu="{{ $item->menu }}" data-sort="{{ $item->sortOrder }}"></i>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="firstModalLabel">Add Category Details</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('menu.store')}}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="menuName" class="form-label">Category</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="editForm" action="" method="POST"> <!-- Action will be updated dynamically -->
                        ...
                        <div class="mb-3">
                            <label for="editMenuName" class="form-label">Category</label>
...
<script>
    ...
    const formData = $(this).serialize(); 
        const url = "{{route('menu.update',['menu' => ':id'])}}".replace(':id',id);
        console.log(url);
    $.ajax({
