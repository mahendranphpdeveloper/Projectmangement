            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="contact-tab" href="#" role="tab" aria-controls="contact" aria-selected="false">
                                Completed Clients
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="settings-tab" href="{{ route('clients.rejected') }}" role="tab" aria-controls="settings" aria-selected="false">
                                Rejected Clients
                            </a>
                        </li>
                    </ul>
